        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          ...
          {status === "done" && (
            <div className="text-center space-y-2">
              ...
              <p className="font-medium text-slate-800">
                Mật khẩu đã được {isReset ? "đặt lại" : "tạo"} thành công!
              </p>
          ...
          {status === "valid" && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1.5">Mật khẩu mới</label>
                <input
                  type="password"
                  value={password}
              ...
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1.5">Xác nhận mật khẩu</label>
                <input
                  type="password"
                  value={confirm}
